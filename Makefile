...
build:
	...
	@$(GO_CROSS_ENV) go build $(GO_TAGS) $(LDFLAGS) -o $(BIN_DIR)/$(BINARY_NAME) .
...
# --- E2E Testing ---
# Run E2E tests. Depends on the main 'daemon' binary.
...
help:
	...
	@echo "  make test-e2e ARGS=...- Run E2E tests (e.g., ARGS=\"-i daemon-basic-generation\")"
