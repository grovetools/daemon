...
`, workspaceDir, notebookRoot)
				...
				if err := os.MkdirAll(planDir, 0o755); err != nil { //nolint:gosec // G301: test dir
					return err
				}
...
`
			...
			harness.NewStep("create mock grove for aglogs", func(ctx *harness.Context) error {
				...
				if err := os.MkdirAll(mockBinDir, 0o755); err != nil { //nolint:gosec // G301: test dir
					return err
				}
...
`
				...
				if err := os.Chmod(grovePath, 0o755); err != nil { //nolint:gosec // G302: test executable
					return err
				}
...
`
				...
				if err := os.Chmod(aglogsPath, 0o755); err != nil { //nolint:gosec // G302: test executable
					return err
				}
